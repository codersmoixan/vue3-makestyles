...
If you need to set custom breakpoints, you can customize them in the <a href="https://github.com/codersmoixan/vue3-makestyles/blob/master/example/theme.js">theme.js</a> file, and then pass the configuration to `ThemeProvider`, so that makeStyles can read the custom configuration.
...
```
You can uniformly configure your css common styles in your <a href="https://github.com/codersmoixan/vue3-makestyles/blob/master/example/theme.js">theme.js</a> file, and bind with the name you define in `name` in the makeStyles function
```JS
  export default createTheme({
    // ...
    css: {
