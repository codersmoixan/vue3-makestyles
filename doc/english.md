...
<br />
You can create a custom configuration file in your project directory, such as <a href="https://github.com/codersmoixan/vue3-makestyles/example/theme.js">theme.js</a>, in which you can customize some of the configurations you need.
```JS
...
```
You can uniformly configure your css common styles in your <a href="https://github.com/codersmoixan/vue3-makestyles/example/theme.js">theme.js</a> file, and bind with the name you define in `componentName` in the makeStyles function
```JS
  export default createTheme({
    // ...
    css: {
