...
function generateThemeTypographyCSS(options) {
    var _a, _b;
    ...
    if (isUndefined(variant))
        return null;
    var variantThemeOptions = (_a = theme.typography) === null || _a === void 0 ? void 0 : _a[variant];
    if (isUndefined(variantThemeOptions)) {
        console.error('A valid "variant" value needs to be passed in, which belongs to the valid values defined in "typography" in "theme.ts/.js"');
        return null;
    }
...
//# sourceMappingURL=generateThemeTypographyCSS.js.map